# Tecnologia Takwara — Maestro do Ecossistema

> Este repositório é o **centro de regência** de todo o ecossistema Takwara. Aqui convergem a governança de agentes de IA, a consolidação do conhecimento aplicado em tecnologia da informação, o mapeamento completo dos repositórios irmãos e a propulsão global da **Tecnologia Takwara de PU Vegetal + Bambu**.

---

## 🌳 Árvore do Ecossistema

O ecossistema Takwara se desenvolve em três camadas históricas:

```
🏛️ TAKWARA-TECH (2019–2025)
    └── Repositório histórico inaugural. Primeira casa da Tecnologia Takwara.
        Deu origem a todo o conhecimento de PU Vegetal, Bambu, tratamentos,
        geodésicas, bioeconomia e governança comunitária.

🌿 PROJETOS / MULHERES-BIOECONOMIA-AMAZONIA (2025–2026)
    └── Repositório histórico que expandiu a pesquisa para bioeconomia amazônica.
        Deu origem ao MQTF (Mulheres Que Tecem a Floresta), à série técnica
        e aos consórcios UnB/UFAC/UFRR.

🎯 MENTORIA_TECNOLOGIA_TAKWARA ← VOCÊ ESTÁ AQUI
    └── Maestro do ecossistema. Resultado do estudo aplicado de TI e da
        regência de agentes de IA. Consolida, governa e propulsiona.
```

---

## 🗺️ Mapa Completo de Repositórios

### Geração 1 — Fundacional
...
| Repositório | Função | GH Pages | Originador |
|---|---|---|---|
| **[Mulheres-Tecem-Amazonia](https://github.com/takwaratec/Mulheres-Tecem-Amazonia)** | 🌿 Consórcio UnB/UFAC/UFRR. Dossiê BNDES, governança comunitária, série Técnica. → **MQTF** | ✅ | takwaratec |
| **[BD-BAMBU](https://github.com/Resck/BD-BAMBU)** | 🎋 Base de dados de espécies de bambu | ❌ | Resck |
...
| Repositório | Função |
|---|---|
| **[Mentoria_Comunidades_RaioX](https://github.com/takwaratec/Mentoria_Comunidades_RaioX)** | Diagnóstico comunitário |
| **[takwara-mentoria-vercel](https://github.com/takwaratec/takwara-mentoria-vercel)** | Deploy Vercel (Nextra) |
| **[docmd-test-takwara](https://github.com/takwaratec/docmd-test-takwara)** | Teste de ferramenta |
...
| `scripts/` | Busca semântica vetorial, scripts de atualização |

---

## 🤖 Regência de Agentes de IA

Este repositório opera como **maestro de agentes de IA** em um ecossistema multi-repositório. O modelo de governança é:

| Componente | Descrição |
|---|---|
| **AGENTS.md Master** | Instruções padronizadas para agentes em todos os repositórios irmãos |
| **FRENTES_DE_TRABALHO.md** | Mapa de atuação — cada frente com escopo, triagem e regras de fronteira |
| **Memória persistente** | Fatos duráveis sobre o ambiente, preferências, convenções |
| **Skills** | Workflows reutilizáveis por tipo de tarefa (editais, fichas, catalogação) |
| **Busca vetorial** | Chromadb + all-MiniLM-L6-v2 — busca semântica 100% local em 7+ repositórios |

**Regra de ouro:** Cada repositório irmão tem seu AGENTS.md derivado deste master. Mantenha a hierarquia: Mentoria (maestro) → AGENTS.md irmãos → execução local.

---

## 🌍 Tecnologia Takwara — PU Vegetal + Bambu

A Tecnologia Takwara é o conjunto de soluções que combinam:
