Charcoal supply chains from Mabalane to Maputo: Who beneﬁts?
Sophia Baumert a,⁎, Ana Catarina Luz b, Janet Fisher c, Frank Vollmer c, Casey M. Ryan c, Genevieve Patenaude c,
Pedro Zorrilla-Miras c, Luis Artur a, Isilda Nhantumbo d, Duncan Macqueen d
a Universidade Eduardo Mondlane, Mozambique
b cE3c – Centre for Ecology, Evolution and Environmental Changes, Universidade de Lisboa, Portugal
c The University of Edinburgh, UK
d International Institute for Environment and Development, UK
a b s t r a c t
a r t i c l e
i n f o
Article history:
...
In urban centres of Mozambique, charcoal is the major energy source for cooking. Growing demand drives high
wood extraction rates over increasing areas of miombo and mopane woodlands. Charcoal production can lead to
...
charcoal production and trade through empirical research conducted in Gaza Province, the main charcoal supply
area for Maputo, Mozambique.
We analyse the present structure of the main charcoal supply chains from Gaza province to Maputo and the proﬁt
distribution along them. Seven villages in the Mabalane district, Gaza, at different stages of engagement with the
...
in Mabalane, under supply chain a) more than 90% of the monetary beneﬁts do not reach local communities and
remain with external agents. Two of the main factors impeding the generation of greater revenues at community
...
We conclude that access to markets and control over woodlands is key if local communities are to generate great-
er beneﬁts from charcoal production while aiming at sustainable charcoal production. Strong local institutions for
...
management
Introduction
Charcoal is one of the major sources of energy in most African coun-
...
and urbanisation, has led to increased wood extraction rates, particular-
ly around urban centres (Ahrends et al., 2010) and contributes to
expanding wood extraction in the woodland areas inhabited by rural
populations. Where this exceeds regrowth rates, forest or woodland
...
coal production could serve as a long-term income source for the poor
Energy for Sustainable Development 33 (2016) 129–138
⁎ Corresponding author.
E-mail address: s.baumert@ed.ac.uk (S. Baumert).
http://dx.doi.org/10.1016/j.esd.2016.06.003
0973-0826/© 2016 The Authors. Published by Elsevier Inc. on behalf of International Energy Initiative. This is an open access article under the CC BY license
(http://creativecommons.org/licenses/by/4.0/).
Contents lists available at ScienceDirect
Energy for Sustainable Development

(Ghilardi et al., 2013; Falcão, 2008), alleviate poverty during the agricul-
tural off-season and improve well-being (Schure et al., 2014b; Zulu and
...
Kambewa et al., 2007; Brouwer and Magane, 1999; Ribot, 1998) showing
...
of entry, collection of proﬁt margins at more than one level and high turn-
...
In Mozambique a few studies analysed the beneﬁt distribution along
...
who are contracted by large-scale urban operators and are not members
...
of beneﬁt sharing mechanisms (i.e., payment of 20% licence fee to com-
...
We ﬁrst present an overview of the legal framework in Mozambique
and elaborate the approaches and methods used in our research. The re-
...
understand who participates at what stage and how. Next, an analysis
of how the legal framework operates in the study area provides insights
...
aiming at joint interventions with the government agencies responsible
for renewable energy, forests and rural development.
Policy and legal framework in Mozambique for charcoal production
Forests and woodlands in Mozambique fall under the responsibility of
the Ministry of Land, Environment and Rural Development (MITADER).
The Forest and Wildlife Law (GoM, 1999) sets the legal basis for sustain-
able use of forest and wildlife resources. Forest resources are the property
...
munity where charcoal production is planned, he/she must conduct local
...
Following, the SPFFB (Provincial Services for Forest and Wildlife) grants
...
130
S. Baumert et al. / Energy for Sustainable Development 33 (2016) 129–138

the licence and the guia in order to detect any illegal charcoal trans-
porting (e.g., transporting more charcoal than licenced, transporting
...
achieving the social objective of the Forest and Wildlife Policy. Through
...
with both National Parks of Limpopo and Banhine, where charcoal
production is not licenced. Mabalane has a semi-arid climate (mean an-
...
mainly consisting of Mopane woodlands. Mopane is one of the preferred
...
licenced charcoal and 3) year with highest charcoal production according
...
calculations in the supplementary information, SI 1 and SI 2). Margins
Fig. 1. Land cover and selected villages in Mabalane, Mozambique. While the land cover and boundaries of the district are accurately represented here, to maintain the anonymity of the
villages investigated, the villages are represented by letters, and their location ﬁctitious.
131
S. Baumert et al. / Energy for Sustainable Development 33 (2016) 129–138

per sack were deﬁned as gross per sack income minus per sack ex-
penses. The net income generation was calculated by multiplying the
...
A deeper understanding about urban marketing activities can be gained
...
was run in the selected villages covering more than 80% of all households
...
The use of multiple methodologies allowed the triangulation of ﬁndings.
...
otherwise. Standard errors were adjusted for nested design (households
nested in villages) through robust cluster estimation. Household and
...
agriculture. With increasing demand for charcoal in Maputo-city and de-
...
areas (Table 2). In village C, the charcoal boom stopped in 2013 when all
...
to 2 licence holders). In the year that ﬁeldwork for this study was under-
taken (2014), charcoal production by large-scale operators was at its
minimum and the remaining trees were used for small-scale production
by villagers. Villagers stated that production had become more difﬁcult
...
from becoming a key production area as they realised early that the
Table 1
...
(89%)
–
FGD: focus group discussion; A committee member is most of the time also “ﬁscal ﬂorestal comunitário”.
a Technicians from the SDAE Mabalane.
b Truck driver.
132
S. Baumert et al. / Energy for Sustainable Development 33 (2016) 129–138

large-scale operators are the main winner of the charcoal production
and do not bring great beneﬁts to the village. Thus, the village committee
restricted the number of large-scale operators in 2013, in order to pre-
serve the remaining woodland resources for their own charcoal produc-
...
views they would not allow the large-scale production as they observed
in the other villages. In village F, an NGO project (1998–2012)
implementing sustainable woodland management restricted the wood-
...
ing factor is access to water.
Studying villages along a charcoal production gradient showed that
...
sibility of the woodland resource, village-level charcoal production rules
...
duction with chainsaws and/or by hiring temporary labour and 22% pro-
duce charcoal on a small scale relying on manual household labour
Table 2
...
89 ± 0.4a
0
HH charcoal production (sacks HH−1 yr−1)
150 ± 20
90 ± 11
130 ± 24
n.o.
...
95 ± 20
0 nsd
Village charcoal production (sacks yr−1)
5016
2401
7535
n.o.
...
Fig. 2. Charcoal value chains identiﬁed in Mabalane district and percentage of production volume (for seven observed villages).
133
S. Baumert et al. / Energy for Sustainable Development 33 (2016) 129–138

force. The average annual production is 124 ± 13 sacks per household,
however, production is unequally distributed across the population
...
port charcoal with the train that passes Mabalane once a week. Estimat-
...
using their own licence to buy charcoal from different areas.
Large-scale production and commercialisation by operators holding an
ofﬁcial licence
...
as 900 MZN per sack. In past, large-scale operators annually contributed
to the villages on the basis of materials (e.g., construction materials such
as cement or poles). This has changed recently to monetary contribution
...
most cases their salary is paid in the form of fuel with which the workers
...
established.
Individual and association licencing
...
heavy ﬁnes (20,000 MZN): it leads to a discrepancy between the area li-
...
their way to Maputo-city, truck drivers (n = 10) reported paying bribes
“refreshments” of 200–1500 MZN to the ofﬁcers at the checkpoints (9 in
...
coal sold on urban markets is produced in accordance to the Forest Law.
...
the distribution of the land to charcoal operators are not well communi-
...
Characteristic
Mean ± SD
Woodland area distributed to each household (ha)
2.4 ± 1.2
...
77 ± 10.2
140 ± 16
SE: standard error. Data from focus group discussions and HH survey.
Table 4
Main characteristics of the large-scale operator model.
Characteristic
Mean ± SD
Provenance of licence holders (156 in year 2014)
Mabalane district centres: 19%
Maputo/Matola: 50%
Other urban areas: 31%
Area distributed to each licence holder (ha)
359 ± 169
Annual licenced charcoal per licence holder
(2013) (sacks)
829 ± 245
Contribution to village (MZN yr−1)
25,000–30,000
Workers per camp
7 ± 4
Origin of workers
Inhambane district: 83%
Size of kiln (sacks)
40 ± 14
Kilns produced per month and worker
1
Payment of workers
30–40% share of production
134
S. Baumert et al. / Energy for Sustainable Development 33 (2016) 129–138

However, the licence history at district level (2009–2014) (Fig. 3)
shows that over the last ﬁve years the charcoal volume licenced to asso-
...
the plano de maneio in 2012 increased the administrative burdens for li-
cence application; and 3) the increase of the licence price from 30 MZN
to 75 MZN per licenced stere in 2012 coincided with decreasing charcoal
production rates in most villages, thus rendering the association's work
economically unviable. However, 4) in villages with sufﬁcient woodland
...
Eventually, not only the revenue generated through association work
is lost but also the revenue from 20% of the licence fee no longer reaches
...
munity where the wood is extracted. Theoretically, if the production is
...
Fig. 4. Income generation for each actor group: A) Income margins per sack; B) Volume of monthly produced/traded charcoal; C) Average net income per month per person.
135
S. Baumert et al. / Energy for Sustainable Development 33 (2016) 129–138

licenced legally and 20% of the licence fee is arriving in the community,
and if the large-scale operators are contributing their share to the village
...
the monetary contribution of the large-scale operators to the communi-
...
ty and access, and little local regulations, the charcoal boom and
woodland exploitation is driven by large-scale operators integrated in
production, transportation and wholesaling and predominantly coming
...
the woodland (SEI, 2002; Luoga et al., 2000). While a link between char-
...
et al., 2006), the question remains as to how communities can maximise
...
majority have little control over the access of others. They have no mar-
...
onstrate this too. Access to markets through licences and transportation
...
gain control over woodland access in order to prevent their wood
Table 5
...
15
15
Fee collected by associations
45
–
Contribution to village by operator
–
25
Revenues to community
60
40
Income margins of local operator
173
–
...
8
Table 6
Total annual income distribution amongst the main actor groups of the value chain and revenue remaining in the community in exemplar pre-boom, boom and post-boom villages in 2013.
...
49
–
Total annual charcoal prod. (thousand sacks)
0
4.6
0
4.6
–
Total annual income (million MZN)
0
1.3
0
0.8
0.3
Mean proportion of total annual income (%)
0
55
0
33
...
21
11
a The community fund consists of revenues collected through the 20% licence fee, the contributions from large-scale operators and the fees collected by associations (Table 5).
136
S. Baumert et al. / Energy for Sustainable Development 33 (2016) 129–138

resources -on which most of the villagers depend- from being entirely
exhausted.
The Law on Forest and Wildlife (GoM, 1999) sets standards for a sus-
...
community guards did state that they do not have the means to control
...
vantageous position in terms of price setting and woodland governance.
...
(Macqueen et al., 2006).
Notwithstanding, the legal framework appears to be a key barrier to
...
sources, viewing them primarily as resource for rural development rath-
...
generated by large-scale operators and wholesalers, while little revenue
...
del Gatto P. Forest law enforcement in Mozambique: an overview. Maputo, Mozambique:
...
the resources. Ecol Econ 2000;35(2):243–57.
Luz AC, et al. Charcoal production and trade in southern Mozambique : historical trends
