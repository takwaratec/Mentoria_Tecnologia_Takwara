...
## 1. O que eles estão propondo?

André mencionou no áudio:
- **Michel** (fábrica) + **Maurilho** (habitação social, sindicatos, movimentos sociais)
- **Sistema construtivo de concreto, painéis** — industrialização
- **Linha de recurso** R$ 3-5M (FINEP Mais Inovação — Linha 4: Moradia Sustentável)
- Parceria com **universidade**

**Perguntas a fazer:**
- Qual o sistema construtivo exato? Concreto armado, painéis pré-moldados, concreto celular?
- Qual o TRL atual? Já tem protótipo? Testes estruturais? Normas técnicas?
- Quem é a universidade parceira? Qual o papel dela?
- O Michel é fabricante de quê? Qual a capacidade instalada?
...
| **Tratamento Sem Veneno** | Preservação de bambu por vapor saturado — substituto de CCA/CCB | 🔬 4-5 | [ficha-tratamento-sem-veneno.md](https://github.com/takwaratec/Analises-e-escrita-cientifica/blob/main/docs/analises/tecnologia-takwara/ficha-tratamento-sem-veneno.md) |
...
## 4. Decisão a tomar na reunião

- [ ] O projeto faz sentido com minha pesquisa ou é forçação?
- [ ] Qual o nível de protagonismo técnico que terei?
- [ ] O cronograma FINEP (31/08) é factível com as entregas?
- [ ] A parceria agrega ou apenas consome tempo?

---

*Preparado por Hermes Agent · Tecnologia Takwara · 29/06/2026*
